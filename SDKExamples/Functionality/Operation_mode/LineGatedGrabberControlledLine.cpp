...
//
//
// File:	LineGatedGrabberControlledLine.cpp
//
...
int main(int argc, char* argv[], char* envp[]){
	...
	int		line_trigger_mode			= GRABBER_CONTROLLED_GATED;
	double	exposure_time_in_microsec	= 19.0;
	...
	if(Fg_setParameter(fg,FG_LINEPERIODE,&periode_time_in_microsec,nCamPort)<0)		{ status = ErrorMessageWait(fg); return status;};
