...
#ifndef CXPSDKCOMMON_H
#define CXPSDKCOMMON_H
...
static unsigned int PortMask = 0x0F;             // all frame grabber ports are activated
static unsigned int NrOfLinks = 4;               // camera specific no. of links
static unsigned int LinkSpeed = LINK_SPEED_3125;  // CXP-bitrate
static unsigned int StreamPaketDataSize = 1024*4;// CXP-Stream Packet Size
