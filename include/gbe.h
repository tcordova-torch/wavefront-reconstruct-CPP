...
#ifdef __cplusplus
namespace GenApi_3_0 { class CNodeMapRef; }
namespace GenApi = GenApi_3_0;
#endif
...
union GbeEventInfoData {
    struct GbeEventInfoData_Discovery discovery;
    struct GbeEventInfoData_CableDiagnostic cablediagnostic;
    struct GbeEventInfoData_TemperatureAlert temperature_alert;
    struct GbeEventInfoData_PhyIrq phy_irq;
    struct GbeEventInfoData_GevEvent gevevent;
    struct GbeEventInfoData_CorruptedFrame corrupted_frame;
    struct GbeEventInfoData_ExternalFrameLoss external_frame_loss;
    struct GbeEventInfoData_LostFrame lost_frame;
    struct GbeEventInfoData_BrokenFrame broken_frame;
    struct GbeEventInfoData_ActionCommandLost actioncommand_lost;
    struct GbeEventInfoData_ActionCommandTimeout actioncommand_timeout;
};
